...
#define FUNC(special,name,numParam) {#name, &SludgeBuiltIn::name, numParam, special},
static BuiltInFunctionData builtinFuncs[] =
{
		FUNC (true, say, -1)
...
#undef FUNC
static const int numBuiltinFuncs = (sizeof(builtinFuncs) / sizeof(builtinFuncs[0]));
